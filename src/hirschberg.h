...
#define HIRSCHBERG(name, cost_type, cost_function)                                          \
    bool name##_subproblems(const char *s1, size_t m, const char *s2, size_t n,             \
        ...
        while (string_subproblem_array_pop(stack, &sub)) {                                  \
            ...
            rev = true;                                                                     \
            cost_function(sub.s1 + sub_m, sub.m - sub_m, sub.s2, sub.n, rev, rev_costs);    \
